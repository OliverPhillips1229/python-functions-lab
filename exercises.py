...
print('Exercise 4: Convert 0°C to Fahrenheit:', convert_temp(0, 'C'))
print('Exercise 4: Convert 32°F to Celsius:', convert_temp(32, 'F'))
...
print('Exercise 8:', product(2, 3, 4, 5, 6))
...
print('Exercise 9.0 Result:', basic_calculator(10, 5, 'subtract'))
print('Exercise 9.1 Result:', basic_calculator(10, 5, 'add'))
print('Exercise 9.2 Result:', basic_calculator(10, 5, 'multiply'))
print('Exercise 9.3 Result:', basic_calculator(10, 5, 'divide'))